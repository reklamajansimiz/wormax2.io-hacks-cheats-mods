// ==UserScript==
// @name         Wormax2.io ZOOM HACK - Wormax2io Hacks - Best Wormax2 Cheat 2019 to 2020
// @description  Wormax2io Mods Features: Speed Hack, Auto Feed, Zoom In/Out, Turn Bot, FPS, Adblock
...
// @updateURL    https://io-mods.com/mods/wormax2io.user.js
// @downloadURL  https://io-mods.com/mods/wormax2io.user.js
// @grant          GM_setValue
// @grant          GM_getValue
// @match        *://wormax2.io/*
// @match        *iogames.space/*
...
//degisenkisimlar
$('#adContainerLeft').prepend('<div style="'+this.st.fpsstyle+'" id="fps" class="fps"></div>');
$('#adContainerLeft').prepend('<div style="'+this.st.formstyle+'"><div class="option1"></div></div>');
...
function changebackground() {
    ...
    $("#adContainerLeft").css("background-color",rgbaC2);
	 $("#adContainerRight").css("background-color",rgbaCol);
}
...
function colorfulmod() {
    ...
    colorsrain = ["transparent"];
      ...
      setInterval(function() {
          ...
          $("#adContainerLeft").css("background-color",rgbaCol);
		   $("#adContainerRight").css("background-color",rgbaCol);
      }, 3000);
}
